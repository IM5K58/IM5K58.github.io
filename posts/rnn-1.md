...
tags: [RNN]
summary: "RNN 1편"
thumbnail: https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxMMsdcj-dQosrudLxBXbTQ3ok6JdIKtVAW6h8RhEORw&s=10
draft: false
source: notion
...
\bullet\text{ 출력층 : } & y_t = f(W_y h_t + b)
\end{aligned}
\\
...
$$
\begin{aligned}x_t &: (d \times 1) \\W_x &: (D_h \times d) \\W_h &: (D_h \times D_h) \\h_{t-1} &: (D_h \times 1) \\b &: (D_h \times 1)\end{aligned}
$$
